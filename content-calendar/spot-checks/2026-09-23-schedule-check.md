# Schedule Story Spot-Check — 2026-09-23

**Run timestamp:** 2026-09-23 12:15 UTC / 08:15 EDT
...
Queried `content-calendar/calendar.json` for `id == "2026-09-23-schedule"` with `content_type == "schedule"`.

- Entry not found.
- Also checked for any `content_type == "schedule"` post dated `2026-09-23` — none found.
- **Last successful schedule post:** `2026-04-28` (posted to IG + FB, both `completed`). That is **148 days ago**.
...
The schedule story for **2026-09-23** is missing from the calendar. The Mac mini cron has not posted a schedule story in 148 days. Manual intervention required.
