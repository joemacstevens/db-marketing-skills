# Schedule Story Spot-Check — 2026-05-28

| Field | Value |
|---|---|
| Run timestamp (UTC) | 2026-05-28T12:16:02Z |
| Run timestamp (ET) | 2026-05-28 08:16 AM ET |
| Checking for | `2026-05-28-schedule` |

## Calendar Entry Status

**MISSING** — `content-calendar/calendar.json` does not exist in the repo. Cannot find entry `id == "2026-05-28-schedule"` with `content_type == "schedule"`.
