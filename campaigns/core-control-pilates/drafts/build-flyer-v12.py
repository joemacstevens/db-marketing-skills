...
v12 changes: Updated pricing — 4 tiers per Menukhah's request:
  Single Class $25 | Intro 5-Pack $100 | 5-Class Pack $115 | 10-Class Pack $180
"""
...
OUT_PDF = os.path.join(BASE, "drafts", "flyer-women-only-packages-v12.pdf")
OUT_PNG = os.path.join(BASE, "drafts", "flyer-women-only-packages-v12.png")
...
photo_h = H * 0.33  # slightly shorter to make room for 4 pricing tiers
photo_y = y - photo_h
...
crop_path = os.path.join(BASE, "drafts", ".temp_v12.jpg")
...
# Brand name
centered(c, "PILATES BY MENUKHAH", y, "Jura-Medium", 24, COCOA)
y -= 22

# Subhead
centered(c, "Women-Only  \u00b7  Beginner Friendly", y, "Lora-Italic", 12, WARM_GRAY)
y -= 24

# ── Pricing — 4 tiers, prominent and clean ─────────────
# Layout: label left of center, price right of center
price_gap = 20  # horizontal gap between label and price columns

# Row 1: Single Class — $25
c.setFont("Jura-Light", 15); c.setFillColor(CHARCOAL)
c.drawString(W/2 - price_gap - c.stringWidth("Single Class", "Jura-Light", 15), y, "Single Class")
c.setFont("Jura-Medium", 20); c.setFillColor(CLAY)
c.drawString(W/2 + price_gap, y, "$25")
y -= 26

# Row 2: Intro 5-Pack — $100
c.setFont("Jura-Light", 15); c.setFillColor(CHARCOAL)
c.drawString(W/2 - price_gap - c.stringWidth("Intro 5-Pack", "Jura-Light", 15), y, "Intro 5-Pack")
c.setFont("Jura-Medium", 20); c.setFillColor(CLAY)
c.drawString(W/2 + price_gap, y, "$100")
y -= 26

# Row 3: 5-Class Pack — $115
c.setFont("Jura-Light", 15); c.setFillColor(CHARCOAL)
c.drawString(W/2 - price_gap - c.stringWidth("5-Class Pack", "Jura-Light", 15), y, "5-Class Pack")
c.setFont("Jura-Medium", 20); c.setFillColor(CLAY)
c.drawString(W/2 + price_gap, y, "$115")
y -= 26

# Row 4: 10-Class Pack — $180
c.setFont("Jura-Light", 15); c.setFillColor(CHARCOAL)
c.drawString(W/2 - price_gap - c.stringWidth("10-Class Pack", "Jura-Light", 15), y, "10-Class Pack")
c.setFont("Jura-Medium", 20); c.setFillColor(CLAY)
c.drawString(W/2 + price_gap, y, "$180")
y -= 26

# ── Contact ───────────────────────────────────────────
centered(c, "(201) 250 6576", y, "Jura-Medium", 12, CHARCOAL)
y -= 16
centered(c, "The Core, 418 Cedar Lane, Teaneck, NJ", y, "Jura-Light", 10.5, WARM_GRAY)
y -= 18

# Schedule
centered(c, "Sunday 8am  \u00b7  Thursday 8pm", y, "Jura-Medium", 12, CHARCOAL)
y -= 16
